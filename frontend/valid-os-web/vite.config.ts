  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/shared/ui/DataTable/TableSkeleton.tsx',
        'src/features/service-orders/components/serviceOrderOptions.ts',
        'src/features/service-orders/api/serviceOrdersQueryOptions.ts',
        'src/**/index.ts',
        'src/**/types.ts',
        'src/**/*-variants.ts',
      ],
